...
import org.testcontainers.containers.Cassandra4Container;
...
public class Cassandra4DatabaseDelegate extends AbstractDatabaseDelegate<CqlSession> {
    ...
    protected CqlSession createNewConnection() {
        try {
            return Cassandra4Container.getCluster(container);
